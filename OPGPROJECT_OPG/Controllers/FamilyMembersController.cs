...
namespace OPGPROJECT_OPG.Controllers
{
    public class FamilyMembersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Surname,Email,Cellphone,Gender")] FamilyMember familyMember)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Surname,Email,Cellphone,Gender")] FamilyMember familyMember)
        {
            if (ModelState.IsValid)
            {
